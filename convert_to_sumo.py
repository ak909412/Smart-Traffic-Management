...
SUMO_ROUTES_FILE = "sumo_routes.rou.xml"
...
def parse_traffic_logs():
    ...
    for entry in root.findall("LogEntry"):
        ...
        mac_address = parts[0].split(":")[-1].strip()  # Extract MAC address
        ...
        if details:
            ...
            vehicles[mac_address] = {
                ...
                "depart": random.randint(0, 30)  # Random departure time
            }
        else:
...
def generate_sumo_xml(vehicles):
    ...
    # Define vehicles
    for mac, data in vehicles.items():
