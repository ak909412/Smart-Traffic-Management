...
// WiFi Credentials
const char* apSSID = "TrafficLight_1";  // Unique SSID for each traffic light
const char* staSSID = "phone";          // Local WiFi SSID
const char* staPassword = "0987654321"; // Local WiFi Password

// Server Details
const char* serverIP = "192.168.118.247"; // Python server IP
const int serverPort = 5000;
const char* trafficLightID = "TrafficLight_1";  // Unique ID for this light
